 ...
 */
@SuppressWarnings("ALL") public class SkittleBuilder {
  ...
  public static final String TEXT_SKITTLE_SKITTLE = "skittle";
  public static final String TEXT_SKITTLE_TEXT = "text";

  @StringDef({ TEXT_SKITTLE_SKITTLE, TEXT_SKITTLE_TEXT }) @Retention(RetentionPolicy.SOURCE)
  public @interface TextSkittleClickType {
  ...
  public interface SkittleClickListener {
    ...
    void onTextSkittleClick(TextSkittle textSkittle, @TextSkittleClickType String type);
  }
  ...
  private void setUp(@NonNull Context context, @NonNull SkittleLayout mSkittleLayout,
      boolean animatable, @Nullable Integer color) {
  ...
  public void setMainSkittleIcon(@NonNull Drawable icon) {
    ...
    FloatingActionButton mSkittle =
        (FloatingActionButton) mSkittleLayout.findViewById(R.id.skittle_main);
    if (icon != null) mSkittle.setImageDrawable(icon);
  }

  /**
   * Call this to change the color of the main skittle,use this method only if you want to
   * change the color of the main skittle dynamically, else use the constructor @see
   * #SkittleBuilder(@NonNull Context
  ...
  private void addTextSkittle(TextSkittle textSkittle) {
    ...
    textSkittle.getTextView().setOnClickListener(mTextSkittle_TextClickListener);
  ...
  View.OnClickListener mSkittleClickListener = new View.OnClickListener() {
    @Override public void onClick(View v) {
      if (v.isClickable() && getmListener() != null) getmListener().onSkittleClick((Skittle) v);
    }
  };
    ...
    @Override public void onClick(View v) {
      if (v.isClickable() && getmListener() != null) {
        getmListener().onTextSkittleClick((TextSkittle) v.getParent(),
            SkittleBuilder.TEXT_SKITTLE_SKITTLE);
      }
    }
  };

  View.OnClickListener mTextSkittle_TextClickListener = new View.OnClickListener() {
    @Override public void onClick(View v) {
      if (getmListener() != null) {
        getmListener().onTextSkittleClick(((TextSkittle) v.getParent()),
            SkittleBuilder.TEXT_SKITTLE_TEXT);
      }
    }
  };
